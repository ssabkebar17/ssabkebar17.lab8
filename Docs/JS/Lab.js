...
// We can use  delete window.global such delete (variable); or  we can clear value on variable from the global object by reassign variable value to empty string .also we can remove DOM element by using remove()
 ...
 var Employee =(function(){
    ...
    console.log(Employee.name) //undefined bcz it private field
    console.log(Employee.age) //undefined bcz it private field
    console.log(Employee.salary)//undefined bcz it private field
    Employee.setAge(23)
    Employee.setName("Meron")
